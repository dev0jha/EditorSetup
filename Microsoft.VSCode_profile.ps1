# This file only exists to be used as a profile for the PowerShell terminal in VSCode. It is not used by the regular PowerShell terminal. This allows us to have different profiles for different terminals.
